...
ActiveRecord::Schema[7.2].define(version: 2025_03_13_005146) do
  ...
  create_table "spree_permission_sets", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.string "set"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_promotion_codes", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["promotion_code_batch_id"], name: "fk_rails_e306e312d9"
  ...
  create_table "spree_role_permissions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "role_id"
